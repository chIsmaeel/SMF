...
public partial record DiagnosticDescriptorsBase
{
    /// <summary>
    /// The _category.
    /// </summary>
    ...
    {
        return new LocalizableResourceString(resourceKey, SRBase.ResourceManager, resourceSource);
    }
    ...
    {
        return new LocalizableResourceString(resourceKey, SRBase.ResourceManager, typeof(Resources.Strings));
    }
}
